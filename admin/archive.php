          ...
          <div class="card">
            <div class="card-body pt-3">
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#ev-Archive<?= $row['id'] ?>">Set as Active</button>
                </li>
              </ul>
                ...
                <div class="tab-pane fade pt-3" id="ev-Archive<?= $row['id'] ?>">
                  <form action="methods/makeactive.php" method="post">
                    <div class="alert alert-warning">
                        <strong>Do you want to make this event active and displayed again at the website?</strong> 
                    </div>
                      <input type="text" name="id" value="<?= $row['id'] ?>" hidden>
