...
$messages = [];
$msgquerry = "SELECT * FROM sent_messages Order By id desc";
...
<head>
  ...
  <title>Review / Sent Messages - TESDA Admin</title>
        ...
        <div class="col-xl-12 list">
            <div class="card info-card customers-card">
                ...
                <div class="card-body">
                    ...
                    <p class="m-2"><?= nl2br($row['messages']) ?></p>
                </div>
            </div>
        </div>
      <?php endforeach ?>
    ...
    <div class="modal fade" id="del<?= $row['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-lg-12">
                <form action="methods/deletesentmessage.php" method="post">
