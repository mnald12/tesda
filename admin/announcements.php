...
$_SESSION['nav-active'] = 'announcements';
...
<head>
  ...
  <title>Manage / Announcements - TESDA Admin</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="newevent.php">Create New Announcements</a></li>
