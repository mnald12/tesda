...
$_SESSION['nav-actives'] = 'announcements';
$tcid = $_SESSION['tcid'];

include 'connection.php';

$announcements = [];
$announcementsquerry = "SELECT * FROM announcements Where tcid = '$tcid' And status = 'Active' Order By id Desc";
                ...
                <div class="tab-pane fade pt-3" id="ev-archive<?= $row['id'] ?>">
                  <form action="methods/movetoarchive.php" method="post">
                    <div class="alert alert-warning">
                        <strong>Would you like to transfer this Announcement to the archives and have it no longer be displayed on the website?</strong> 
                    </div>
                      <input type="text" name="id" value="<?= $row['id'] ?>" hidden>
